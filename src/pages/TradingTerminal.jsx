        ...
        <div className="space-y-6">
          <Section title="Order ticket" subtitle="Paper-first ticket modeled for F&O desk usage.">
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-1">
              <Stat label="Route state" value={executionGuard.liveMode ? 'Live mode requested' : 'Paper mode'} note={brokerConnected ? 'Live routing requires arming and confirmation.' : 'Broker disconnected, paper flow only.'} tone={executionGuard.liveMode ? 'amber' : 'slate'} />
